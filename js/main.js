...
function initLazyYouTube() {
  ...
  document.addEventListener('click', (e) => {
    ...
    if (videoType === 'instagram') {
      ...
      // Added vq=hd1080, cc_load_policy=0, and iv_load_policy=3 per user request
      iframe.src = `https://www.youtube-nocookie.com/embed/${videoId}?autoplay=1&rel=0&mute=0&vq=hd1080&controls=1&cc_load_policy=0&iv_load_policy=3`;
    }
